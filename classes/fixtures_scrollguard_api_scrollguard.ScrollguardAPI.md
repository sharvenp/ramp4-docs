[ramp - v4.2.0-beta](../README.md) / [Modules](../modules.md) / [fixtures/scrollguard/api/scrollguard](../modules/fixtures_scrollguard_api_scrollguard.md) / ScrollguardAPI

# Class: ScrollguardAPI

[fixtures/scrollguard/api/scrollguard](../modules/fixtures_scrollguard_api_scrollguard.md).ScrollguardAPI
...
- [constructor](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#constructor)

### Properties

- [$iApi](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#$iapi)
- [id](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#id)

### Accessors

- [$element](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#$element)
- [$vApp](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#$vapp)
- [config](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#config)

### Methods

- [\_parseConfig](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#_parseconfig)
- [added](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#added)
- [extend](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#extend)
- [getLayerFixtureConfig](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#getlayerfixtureconfig)
- [getLayerFixtureConfigs](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#getlayerfixtureconfigs)
- [handlePanelWidths](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#handlepanelwidths)
- [initialized](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#initialized)
- [mount](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#mount)
- [remove](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#remove)
- [removed](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#removed)
- [setEnabled](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#setenabled)
- [terminated](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#terminated)
- [updateBaseToInstance](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md#updatebasetoinstance)

## Constructors

### constructor

• **new ScrollguardAPI**(`id`, `iApi`)
...
• `get` **config**(): `undefined` \| `ScrollguardConfig`
...
[src/fixtures/scrollguard/api/scrollguard.ts:27](https://github.com/sharvenp/ramp4-docs/blob/c6cdb39/src/fixtures/scrollguard/api/scrollguard.ts#L27)

## Methods

### \_parseConfig

▸ **_parseConfig**(`scrollguardConfig?`): `void`
...
| Name | Type |
| :------ | :------ |
| `scrollguardConfig?` | `ScrollguardConfig` |
...
[src/fixtures/scrollguard/api/scrollguard.ts:22](https://github.com/sharvenp/ramp4-docs/blob/c6cdb39/src/fixtures/scrollguard/api/scrollguard.ts#L22)
...
▸ **remove**(): [`ScrollguardAPI`](fixtures_scrollguard_api_scrollguard.ScrollguardAPI.md)
...
[src/fixtures/scrollguard/api/scrollguard.ts:12](https://github.com/sharvenp/ramp4-docs/blob/c6cdb39/src/fixtures/scrollguard/api/scrollguard.ts#L12)
