[ramp - v4.2.0-beta](../README.md) / [Modules](../modules.md) / [fixtures/grid/api/grid](../modules/fixtures_grid_api_grid.md) / GridAPI

# Class: GridAPI

[fixtures/grid/api/grid](../modules/fixtures_grid_api_grid.md).GridAPI
...
- [constructor](fixtures_grid_api_grid.GridAPI.md#constructor)

### Properties

- [$iApi](fixtures_grid_api_grid.GridAPI.md#$iapi)
- [id](fixtures_grid_api_grid.GridAPI.md#id)

### Accessors

- [$element](fixtures_grid_api_grid.GridAPI.md#$element)
- [$vApp](fixtures_grid_api_grid.GridAPI.md#$vapp)
- [config](fixtures_grid_api_grid.GridAPI.md#config)

### Methods

- [\_parseConfig](fixtures_grid_api_grid.GridAPI.md#_parseconfig)
- [added](fixtures_grid_api_grid.GridAPI.md#added)
- [extend](fixtures_grid_api_grid.GridAPI.md#extend)
- [getLayerFixtureConfig](fixtures_grid_api_grid.GridAPI.md#getlayerfixtureconfig)
- [getLayerFixtureConfigs](fixtures_grid_api_grid.GridAPI.md#getlayerfixtureconfigs)
- [handlePanelWidths](fixtures_grid_api_grid.GridAPI.md#handlepanelwidths)
- [initialized](fixtures_grid_api_grid.GridAPI.md#initialized)
- [mount](fixtures_grid_api_grid.GridAPI.md#mount)
- [remove](fixtures_grid_api_grid.GridAPI.md#remove)
- [removed](fixtures_grid_api_grid.GridAPI.md#removed)
- [terminated](fixtures_grid_api_grid.GridAPI.md#terminated)
- [toggleGrid](fixtures_grid_api_grid.GridAPI.md#togglegrid)
- [updateBaseToInstance](fixtures_grid_api_grid.GridAPI.md#updatebasetoinstance)
...
[src/fixtures/grid/api/grid.ts:55](https://github.com/sharvenp/ramp4-docs/blob/c6cdb39/src/fixtures/grid/api/grid.ts#L55)
...
▸ **remove**(): [`GridAPI`](fixtures_grid_api_grid.GridAPI.md)
...
[src/fixtures/grid/api/grid.ts:14](https://github.com/sharvenp/ramp4-docs/blob/c6cdb39/src/fixtures/grid/api/grid.ts#L14)
