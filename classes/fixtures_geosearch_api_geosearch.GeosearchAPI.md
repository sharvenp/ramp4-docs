[ramp - v4.2.0-beta](../README.md) / [Modules](../modules.md) / [fixtures/geosearch/api/geosearch](../modules/fixtures_geosearch_api_geosearch.md) / GeosearchAPI

# Class: GeosearchAPI

[fixtures/geosearch/api/geosearch](../modules/fixtures_geosearch_api_geosearch.md).GeosearchAPI
...
- [constructor](fixtures_geosearch_api_geosearch.GeosearchAPI.md#constructor)

### Properties

- [$iApi](fixtures_geosearch_api_geosearch.GeosearchAPI.md#$iapi)
- [id](fixtures_geosearch_api_geosearch.GeosearchAPI.md#id)

### Accessors

- [$element](fixtures_geosearch_api_geosearch.GeosearchAPI.md#$element)
- [$vApp](fixtures_geosearch_api_geosearch.GeosearchAPI.md#$vapp)
- [config](fixtures_geosearch_api_geosearch.GeosearchAPI.md#config)

### Methods

- [added](fixtures_geosearch_api_geosearch.GeosearchAPI.md#added)
- [extend](fixtures_geosearch_api_geosearch.GeosearchAPI.md#extend)
- [getLayerFixtureConfig](fixtures_geosearch_api_geosearch.GeosearchAPI.md#getlayerfixtureconfig)
- [getLayerFixtureConfigs](fixtures_geosearch_api_geosearch.GeosearchAPI.md#getlayerfixtureconfigs)
- [handlePanelWidths](fixtures_geosearch_api_geosearch.GeosearchAPI.md#handlepanelwidths)
- [initialized](fixtures_geosearch_api_geosearch.GeosearchAPI.md#initialized)
- [mount](fixtures_geosearch_api_geosearch.GeosearchAPI.md#mount)
- [remove](fixtures_geosearch_api_geosearch.GeosearchAPI.md#remove)
- [removed](fixtures_geosearch_api_geosearch.GeosearchAPI.md#removed)
- [terminated](fixtures_geosearch_api_geosearch.GeosearchAPI.md#terminated)
- [updateBaseToInstance](fixtures_geosearch_api_geosearch.GeosearchAPI.md#updatebasetoinstance)

## Constructors

### constructor

• **new GeosearchAPI**(`id`, `iApi`)
...
▸ **remove**(): [`GeosearchAPI`](fixtures_geosearch_api_geosearch.GeosearchAPI.md)
