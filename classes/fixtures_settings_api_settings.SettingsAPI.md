[ramp - v4.2.0-beta](../README.md) / [Modules](../modules.md) / [fixtures/settings/api/settings](../modules/fixtures_settings_api_settings.md) / SettingsAPI

# Class: SettingsAPI

[fixtures/settings/api/settings](../modules/fixtures_settings_api_settings.md).SettingsAPI
...
- [constructor](fixtures_settings_api_settings.SettingsAPI.md#constructor)

### Properties

- [$iApi](fixtures_settings_api_settings.SettingsAPI.md#$iapi)
- [id](fixtures_settings_api_settings.SettingsAPI.md#id)

### Accessors

- [$element](fixtures_settings_api_settings.SettingsAPI.md#$element)
- [$vApp](fixtures_settings_api_settings.SettingsAPI.md#$vapp)
- [config](fixtures_settings_api_settings.SettingsAPI.md#config)

### Methods

- [added](fixtures_settings_api_settings.SettingsAPI.md#added)
- [extend](fixtures_settings_api_settings.SettingsAPI.md#extend)
- [getLayerFixtureConfig](fixtures_settings_api_settings.SettingsAPI.md#getlayerfixtureconfig)
- [getLayerFixtureConfigs](fixtures_settings_api_settings.SettingsAPI.md#getlayerfixtureconfigs)
- [handlePanelWidths](fixtures_settings_api_settings.SettingsAPI.md#handlepanelwidths)
- [initialized](fixtures_settings_api_settings.SettingsAPI.md#initialized)
- [mount](fixtures_settings_api_settings.SettingsAPI.md#mount)
- [remove](fixtures_settings_api_settings.SettingsAPI.md#remove)
- [removed](fixtures_settings_api_settings.SettingsAPI.md#removed)
- [terminated](fixtures_settings_api_settings.SettingsAPI.md#terminated)
- [toggleSettings](fixtures_settings_api_settings.SettingsAPI.md#togglesettings)
- [updateBaseToInstance](fixtures_settings_api_settings.SettingsAPI.md#updatebasetoinstance)

## Constructors

### constructor

• **new SettingsAPI**(`id`, `iApi`)
...
▸ **remove**(): [`SettingsAPI`](fixtures_settings_api_settings.SettingsAPI.md)
...
▸ **toggleSettings**(`layer`, `open?`): `void`
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `layer` | [`LayerInstance`](geo_layer_layer_instance.LayerInstance.md) | controlled layer |
...
[src/fixtures/settings/api/settings.ts:9](https://github.com/sharvenp/ramp4-docs/blob/c6cdb39/src/fixtures/settings/api/settings.ts#L9)
