[ramp - v4.2.0-beta](../README.md) / [Modules](../modules.md) / [fixtures/overviewmap/api/overviewmap](../modules/fixtures_overviewmap_api_overviewmap.md) / OverviewmapAPI

# Class: OverviewmapAPI

[fixtures/overviewmap/api/overviewmap](../modules/fixtures_overviewmap_api_overviewmap.md).OverviewmapAPI
...
- [constructor](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#constructor)

### Properties

- [$iApi](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#$iapi)
- [id](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#id)

### Accessors

- [$element](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#$element)
- [$vApp](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#$vapp)
- [config](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#config)

### Methods

- [\_parseConfig](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#_parseconfig)
- [added](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#added)
- [extend](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#extend)
- [getLayerFixtureConfig](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#getlayerfixtureconfig)
- [getLayerFixtureConfigs](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#getlayerfixtureconfigs)
- [handlePanelWidths](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#handlepanelwidths)
- [initialized](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#initialized)
- [mount](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#mount)
- [remove](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#remove)
- [removed](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#removed)
- [terminated](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#terminated)
- [updateBaseToInstance](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md#updatebasetoinstance)

## Constructors

### constructor

• **new OverviewmapAPI**(`id`, `iApi`)
...
[src/fixtures/overviewmap/api/overviewmap.ts:30](https://github.com/sharvenp/ramp4-docs/blob/c6cdb39/src/fixtures/overviewmap/api/overviewmap.ts#L30)

## Methods

### \_parseConfig

▸ **_parseConfig**(`overviewmapConfig?`): `void`
...
[src/fixtures/overviewmap/api/overviewmap.ts:12](https://github.com/sharvenp/ramp4-docs/blob/c6cdb39/src/fixtures/overviewmap/api/overviewmap.ts#L12)
...
▸ **remove**(): [`OverviewmapAPI`](fixtures_overviewmap_api_overviewmap.OverviewmapAPI.md)
