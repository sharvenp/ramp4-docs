[ramp - v4.2.0-beta](../README.md) / [Modules](../modules.md) / [geo/utils/attribute](../modules/geo_utils_attribute.md) / ArcServerAttributeLoader
...
• **new ArcServerAttributeLoader**(`iApi`, `details`)
